...
export default function Units() {
    ...
    const submitData = (e) => {
        ...
        if (categoryData.id) {
            http.put(`update-units/${categoryData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setContent();
                ...
                <div className="product_modal">
                    <div className="page-content">
                        <div className=" patients-head ">
                            <h5 className="fw-normal custom_py-3 px-2  text-start mb-2 card-name">Add Unit
