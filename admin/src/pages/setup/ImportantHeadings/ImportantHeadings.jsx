...
export default function ImportantHeadings() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-important-heading/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const submitData = (e) => {
        e.preventDefault()
        if (headingData.id) {
            http.put(`update-important-heading/${headingData.id}`, headingData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
            ...
            http.post('save-important-heading', headingData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setHeadingData({ title: "" });
