...
export default function TopSlider() {
    ...
    const submitData = (e) => {
        ...
        formData.append('date', slideData.date);
        if (slideData.id) {
            http.put(`update-slide/${slideData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    ...
                    <div className="page-content">
                        ...
                        <div className=" p-3">
                            <form onSubmit={submitData}>
                                {/* <input onChange={handleChange} name='name' value={slideData.name} type="text" className="form-control form-control-sm my-2" required placeholder="News" /> */}
