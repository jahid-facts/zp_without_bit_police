...
export default function ZillaPoliceSubPage() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-zilla-police-sub-pages/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        http.get(`zilla-police-sub-pages/${id}`)
            .then((res) => {
    ...
    const submitData = (e) => {
        ...
        if (categoryData.id) {
            http.put(`update-zilla-police-sub-pages/${categoryData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
            ...
            http.post('save-zilla-police-sub-pages', formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setContent("");
