...
export default function ContactPerson() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-contact-person/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const submitData = (e) => {
        ...
        if (categoryData.id) {
            http.put(`update-contact-person/${categoryData.id}`, categoryData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setCategoryData({ name: "", email:"",index : "" });
                    Swal.fire({
                        position: 'top-center',
                        icon: 'success',
                        title: 'Success !',
            ...
            http.post('save-contact-person', categoryData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setCategoryData({ name: "", email:"", index : "" });
                    ...
                    <div className="page-content">
                        ...
                        <div className=" p-3">
                            <form onSubmit={submitData}>
                                ...
                                <input onChange={handleChange} value={categoryData.email} name="email" type="email" className="form-control form-control-sm my-2" required placeholder="Email" />
