...
export default function ExSp() {
    ...
    const submitData = (e) => {
        ...
        formData.append('designationId', slideData.designationId);
        if (slideData.id) {
            http.put(`update-ex-sp/${slideData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    ...
                    <div className="page-content">
                        ...
                        <div className=" p-3">
                            <form onSubmit={submitData}>
                                <div className="row">
                                    <div className="col-3">
                                        <label>Designation Page</label>
                                    </div>
                                    <div className="col-9">
                                        <select name="designationId" onChange={handleChange} value={slideData.designationId} className="form-control form-control-sm my-2" required>
                                            <option value="">Select Designation Page</option>
                                            {
