...
export default function PhoneDirectorySubCategory() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-directory-sub-categories/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        http.get(`directory-sub-categories/${id}`)
            .then((res) => {
    ...
    const submitData = (e) => {
        ...
        if (categoryData.id) {
            http.put(`update-directory-sub-categories/${categoryData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
            ...
            http.post('save-directory-sub-categories', formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setCategoryData({ title: "", workSectionId: "" });
