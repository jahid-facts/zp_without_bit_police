...
export default function PhoneDirectoryCategory() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-directory-categories/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        http.get(`directory-categories/${id}`)
            .then((res) => {
    ...
    const submitData = (e) => {
        ...
        if (categoryData.id) {
            http.put(`update-directory-categories/${categoryData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
            ...
            http.post('save-directory-categories', formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setCategoryData({ title: "", workSectionId: "" });
