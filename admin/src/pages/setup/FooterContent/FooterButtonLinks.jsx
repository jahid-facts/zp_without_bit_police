...
export default function FooterButtonLinks() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-footer-button-link/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        http.get(`footer-button-link/${id}`)
            .then((res) => {
    ...
    const submitData = (e) => {
        e.preventDefault()
        if (contentData.id) {
            http.put(`update-footer-button-link/${contentData.id}`, contentData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
            ...
            http.post('save-footer-button-link', {title: contentData.title, link: contentData.link})
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setContentData({ title: "",  link: "" });
