...
export default function CrimeManagement() {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    http.delete(`delete-crime-pages/${id}`)
                        .then((res) => {
                            setUpdate(!update);
                            setIsOpen(false);
                            Swal.fire({
    ...
    const submitData = (e) => {
        ...
        if (categoryData.id) {
            http.put(`update-crime-pages/${categoryData.id}`, formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
            ...
            http.post('save-crime-pages', formData)
                .then((res) => {
                    setUpdate(!update);
                    setIsOpen(false);
                    setContent("");
